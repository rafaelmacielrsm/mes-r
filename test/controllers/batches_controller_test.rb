...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { barcode: @batch.barcode, cost: @batch.cost, expiration_date: @batch.expiration_date } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { barcode: @batch.barcode, cost: @batch.cost, expiration_date: @batch.expiration_date } }
